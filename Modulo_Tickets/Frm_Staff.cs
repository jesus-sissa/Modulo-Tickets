...
namespace Modulo_Tickets
{
    public partial class Frm_Staff : Form
    {
        ...
        private void Cliq(Object sender, EventArgs e)
        {
            ...
            Id_RubroSeleccionado = Convert.ToInt32(btn.Name);
            Filtro = false;
            Listar_Tickets(new TicketRequest { Id_Rubro = Id_RubroSeleccionado }, Filtro);
        }
        ...
        private void filtroToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                else if(dr==DialogResult.Yes)
                {
                    if (_Posicion+1 < Dgv_Tickets.Rows.Count)
                    {
                        ...
                        Dgv_Tickets_CellClick_1(Dgv_Tickets, new DataGridViewCellEventArgs(0, _ = _Posicion + 1));
                    }
                    else
                    {
                        Check();
                        Dgv_Tickets.CurrentCell = Dgv_Tickets.Rows[0].Cells[0];
                        Dgv_Tickets_CellClick_1(Dgv_Tickets, new DataGridViewCellEventArgs(0,0));
                    }
                }
